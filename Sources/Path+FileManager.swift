...
extension Pathish {
	 ...
	 */
	@discardableResult
	public func copy<P: Pathish>(to: P, overwrite: Bool = false) throws -> Path {
	 ...
	 */
	@discardableResult
	public func copy<P: Pathish>(into: P, overwrite: Bool = false) throws -> Path {
		if into.type == nil {
			try into.mkdir(.p)
		}
	 ...
	 */
	@discardableResult
	public func move<P: Pathish>(to: P, overwrite: Bool = false) throws -> Path {
	 ...
	 */
	@discardableResult
	public func move<P: Pathish>(into: P, overwrite: Bool = false) throws -> Path {
		switch into.type {
		case nil:
			try into.mkdir(.p)
			fallthrough
	 ...
	 */
	@discardableResult
	public func mkdir(_ options: MakeDirectoryOptions? = nil) throws -> Path {
		do {
			let wid = options == .p
			try FileManager.default.createDirectory(at: url, withIntermediateDirectories: wid, attributes: nil)
	 ...
	 */
	@discardableResult
	public func rename(to newname: String) throws -> Path {
	 ...
	 */
	@discardableResult
	public func symlink<P: Pathish>(as: P) throws -> Path {
	 ...
	 */
	@discardableResult
	public func symlink<P: Pathish>(into dir: P) throws -> Path {
		switch dir.type {
		case nil, .symlink?:
			try dir.mkdir(.p)
			fallthrough
